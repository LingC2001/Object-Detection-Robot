...
class EKF:
    ...
    def draw_slam_state(self, res = (320, 500), not_pause=True):
        ...
        # print(self.target_est)

        for key, value in self.target_est.items():
            if 'apple' in key:
                colour = (255, 0, 0)
            elif 'lemon' in key:
                colour = (255, 255, 0)
            ...
            coor_ = self.to_im_coor((value['x']-robot_xy[0], value['y']-robot_xy[1]), res, m2pixel)
            pygame.draw.circle(surface, colour, coor_ ,5)
